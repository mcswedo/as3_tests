...
package states
{
	...
	public class Play extends Sprite implements IState //Because this is a state, it implements the IState Interface.
	{
		...
		public function Play(game:Game) //And pass it into our Menu constructor.
		{
			this.game = game;
